...
// ── Detectar navegador Chromium instalado (Chrome, Edge o Brave) ──────────
  ...
  for (const ruta of rutas) {
    try {
      if (fs.existsSync(ruta)) {
        console.log("Navegador encontrado:", ruta);
        return ruta;
      }
    } catch (e) {}
  }
  console.warn("No se encontro navegador instalado, usando el de puppeteer por defecto");
  return undefined;
}
